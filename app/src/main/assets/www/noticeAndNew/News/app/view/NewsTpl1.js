 ...
 */
Ext.define('iNews.view.NewsTpl1',{
            ...
            items:[
                {
                    ...
                    cls:'backBtnCls',
                    handler:function(){
                        this.up('newstpl1view').fireEvent("tpl1back",this);
                    }
                }
            ]
        },
            ...
            listeners:{
                'tap':{
                    fn : function() {
                        ...
                        this.up('newstpl1view').fireEvent("line1_tap",this,record);
                    },
                    element : 'element'
                }
            }
            ...
            items:[{
                ...
                listeners:{
                        'tap':{
                            fn : function() {
                                var record = this.getData() == null ? "":this.getData();
                                this.up('newstpl1view').fireEvent("line2_left_tap",this,record);
                            },
                            element : 'element'
                        }
                }
                ...
                listeners:{
                    'tap':{
                        fn : function() {
                            var record = this.getData() == null ? "":this.getData();
                            this.up('newstpl1view').fireEvent("line2_right_tap",this,record);
                        },
                        element : 'element'
                    }
                }
            ...
            items:[{
                ...
                listeners:{
                    'tap':{
                        fn : function() {
                            var record = this.getData() == null ? "":this.getData();
                            this.up('newstpl1view').fireEvent("line3_left_tap",this,record);
                        },
                        element : 'element'
                    }
                }
                ...
                listeners:{
                    'tap':{
                        fn : function() {
                            var record = this.getData() == null ? "":this.getData();
                            this.up('newstpl1view').fireEvent("line3_right_tap",this,record);
                        },
                        element : 'element'
                    }
                }
    ...
    setRecords:function(records){
        console.log("in template1 setRecords method:",records);
        console.log(this.query("container"));
        var me = this,
			...
			/*
				if(records[0].ImageUrl != null){
					line1Img = records[0].ImageUrl
				}else{
					line1Img = ""
				}
		    
        line1.setData({"NewsId":records[0].NewsId,"Title":records[0].Title,"PublishTime":records[0].PublishTime,"ImgUrl":records[0].ImageUrl});
        line2_left.setData({"NewsId":records[1].NewsId,"Title":records[1].Title,"PublishTime":records[1].PublishTime,"ImgUrl":records[1].ImageUrl});
        line2_right.setData({"NewsId":records[2].NewsId,"Title":records[2].Title,"PublishTime":records[2].PublishTime,"ImgUrl":records[2].ImageUrl});
        line3_left.setData({"NewsId":records[3].NewsId,"Title":records[3].Title,"PublishTime":records[3].PublishTime,"ImgUrl":records[3].ImageUrl});
        line3_right.setData({"NewsId":records[4].NewsId,"Title":records[4].Title,"PublishTime":records[4].PublishTime,"ImgUrl":records[4].ImageUrl});
        line4.setData({"NewsId":records[5].NewsId,"Title":records[5].Title,"PublishTime":records[5].PublishTime,"ImgUrl":records[5].ImageUrl});
	*/	
